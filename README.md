...
![Actionable Alerts](screenshots/01-actionable_alerts.PNG)
![Dashboard Overview](screenshots/03-dashboard_overview.PNG)

### Performance Insights
![Advertising Performance](screenshots/02-advertising_performance.PNG)
![Sales Analysis](screenshots/04-sales_analysis.PNG)

### Terminal Run Example
![Terminal Run](screenshots/05-terminal_run.PNG)
